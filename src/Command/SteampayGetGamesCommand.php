...
/**
 * Команда импорта игр из Steampay.
 *
 * Системное имя: app:steampay-get-games
 *
 * Назначение:
 *   Связывает существующие игры в базе данных с магазином Steampay, если для них существует валидная страница.
 *
 * Логика работы:
 *   - Получает все игры из базы данных.
 *   - Для каждой игры:
 *       - Генерирует slug на основе названия игры.
 *       - Проверяет существование страницы на Steampay по URL.
 *       - Если страница существует — создает связь GameShop.
 *       - Если страница не найдена — отмечает в SteampayApp как not found.
 ...
 *   - Кэширует информацию о не найденных страницах в SteampayApp.
...
class SteampayGetGamesCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $logsCron->setCronName('steampay-get-games');
