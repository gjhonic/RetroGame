...
/**
 * Команда обновления цен на игры Steampay.
 *
 * Системное имя: app:steampay-update-prices
 *
 * Назначение:
 *   Получает актуальные цены на игры из Steampay и сохраняет их в историю цен.
 *
 * Логика работы:
 *   - Находит все игры Steampay, для которых требуется обновление цены (shop=Steampay, shouldImportPrice=true).
 *   - Для каждой игры:
 *       - Проверяет, обновлялась ли цена сегодня.
 *       - Получает страницу игры с сайта Steampay.
 *       - Извлекает цену из блока product__current-price.
